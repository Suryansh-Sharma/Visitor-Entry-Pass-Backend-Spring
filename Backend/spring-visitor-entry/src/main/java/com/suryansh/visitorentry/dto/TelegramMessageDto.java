 ...
 * @param location It includes a location of visit e.g.: Reception,Office etc.
 * @param city It includes the resident city of a visitor.
 * @param line1 It includes area, colony etc. info of user address.
 *
 * @author suryansh
 */
public record TelegramMessageDto(String visitorContact,String visitorName
        ,String reason , String visitorImage ,String location,String city,String line1) {
}
